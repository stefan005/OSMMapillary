...
BASE_DIR = 'C:/Users/Stefan/PycharmProjects/OSMMapillaryGit/downloaded/'
...
query = query_search_api(13.2493683, 52.5153490, 10)  # create_dirs(BASE_DIR+'asphalt/')
download_images(query, BASE_DIR + 'asphalt/')
# In[136]:


for i in range(3984, len(df_joined_list)):
